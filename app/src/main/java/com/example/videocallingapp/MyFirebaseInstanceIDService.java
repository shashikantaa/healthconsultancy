...
public class MyFirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    private static final String SUBSCRIBE_TO = "userDoctorapp";//this should be changed(different) when used in another App and
    //must match to topic in MainActivity.java file
